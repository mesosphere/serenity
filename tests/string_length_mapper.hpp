...
#ifndef SERENITY_STRING_LENGTH_MAPPER_H
#define SERENITY_STRING_LENGTH_MAPPER_H
...
class StringLengthMapper : public Consumer<std::string>, public Producer<int>
{
public:

  StringLengthMapper(){};
  ~StringLengthMapper() noexcept;

  Try<Nothing> consume(std::string value);

private:
  StringLengthMapper(StringLengthMapper& other) {};
...
#endif //SERENITY_STRING_LENGTH_MAPPER_H
